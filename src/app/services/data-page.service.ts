...
export class DataPageService {
  ...
  constructor(private _HttpClient: HttpClient) {
    this.getInfoPage().subscribe((response: PageInfo) => {
  ...
  getInfoPage() {
    return this._HttpClient
      .get('https://luisgaliciadev-default-rtdb.firebaseio.com/info_page.json')
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  getPortafolio() {
    return this._HttpClient
      .get('https://luisgaliciadev-default-rtdb.firebaseio.com/portafolio.json')
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  getPortafolioItem(id) {
    return this._HttpClient
      .get(
        'https://luisgaliciadev-default-rtdb.firebaseio.com/portafolio-item/' +
          id +
          '.json'
      )
      .pipe(
  ...
  sendMail(data) {
    ...
    return this._HttpClient
      .post(this.URL + '/mailPortafolio/sendMail', params, { headers })
      .pipe(
        map((res: any) => {
